...
import { Search, Plus, X, FileText, Printer } from "lucide-react";
...
const categorias = [
  ...
  { id: "laboratorial", label: "Laboratorial", color: "green" },
  { id: "imagem", label: "Imagem", color: "purple" },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {filteredExames.map((tipo) => {
          const isSelected = selectedExams.find(
            (e) => e.tipo_exame_id === tipo.id
          );
          return (
            <div
              key={tipo.id}
            ...
            {selectedExams.map((exam) => (
              ...
              >
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateExam(exam.tipo_exame_id, "prioridade", e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateExam(exam.tipo_exame_id, "indicacao_clinica", e.target.value)
                  }
